...
using QYMSERVER.Sessions;
using QYMSERVER.Web.Controllers.Results;
using QYMSERVER.Web.Models;
using QYMSERVER.Web.Models.Account;
...
{
    public class AccountController : QYMSERVERControllerBase
    {
